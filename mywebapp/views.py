...
from .forms import InvoiceStatusTableForm,POTableForm,VendorForm,IssueTicketForm
...
def home(req):
    ...
    return render(req,'index.html',{"invoices":invoices,"sum_of_pending_amount":sum_of_pending_amount,"count_of_pending_invoices":count_of_pending_invoices,"count_of_records_with_null_invoice":count_of_records_with_null_invoice})
